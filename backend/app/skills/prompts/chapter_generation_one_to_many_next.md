...
🔴 结尾规则（钩子/伏笔回收）：
- 本章最后一段必须落在以下任一形式，按伏笔回收三模式选择：
  a) 【动作截断式】一个动作即将完成但被截断（刀已举起还没落下/手指碰到门还没推开/话到嘴边还没说出来）
  b) 【信息倾斜式】一个确定的信息完整呈现，但只呈现信息本身，不解释含义、不写角色的判断——信息必须完整，后果留给下一章（例：门开了，里面站着那个三年前死掉的人 / 他翻开账簿，看到最后一行写着自己的名字）
  c) 【人物反应式】角色收到了一个信号但没有回应——写身体反应（手停住了/瞳孔缩了一下/后退了半步），不写内心活动。此选项仅限非小高潮章使用
- 本章结尾的钩子必须产生紧迫感而非仅仅疑问感。读者必须觉得下一页不翻就会错过关键信息
- 小高潮章的结尾必须是 a 或 b——要么读者知道了但角色还不知道的危险，要么一个决定性的选择即将做出
- 禁止以总结句、感悟句、场景安静下来的描写、角色入睡/离开/关门作为结尾
- 禁止：角色或旁白口头宣告钩子内容（如”今夜要去承乾宫侍寝”）
- 禁止：用”他不知道的是””等待他的将是””这意味着”等解释句收束
- 禁止：小高潮章结尾使用普通疑问句钩子
...
- 禁止：角色对话中直接说出钩子关键信息、旁白直接揭示"他不知道的是……"
