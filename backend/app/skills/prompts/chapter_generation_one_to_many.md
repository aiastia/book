...
【对话与互动自检——别写成一人的独角戏】
- 全章有几个人开口了？只有主角一人说话，拉一个配角进来当面交锋（5-8个来回）。
- 有没有一段"两个人同框、有来有回"的戏？没有，加一段。
- 对话占比低于 25% 吗？是，把一段心理活动/观察改成对话或互动。

【结尾自检——结尾不狠，留存就垮】
- 最后一句停在张力最高点，还是"平稳收束"了？后者必须改。
- 有没有用"平静""安静""归于沉寂"或开放式反问收尾？有，删掉换成动作截断/真相一角/力量倾斜。
- 最后一句是否短而重（≤20字，一个具体动作/物件）？
