...
async def generate_organization(
    ...
    result = await engine.execute_skill(
        ...
        ai_client,
        {
            "title": proj.title,
            "genre": proj.genre or "网文",
            "theme": proj.synopsis or proj.genre or "网文",
            "time_period": proj.world_time_period or "未设定",
            "location": proj.world_location or "未设定",
            "atmosphere": proj.world_atmosphere or "未设定",
            "rules": proj.world_rules or "未设定",
            ...
            "organization_specification": req.user_input or "自动生成",
            "mcp_references": "",
                ...
                for i in range(count):
                    ...
                    result = await engine.execute_skill(
                        ...
                        ai_client,
                        {
                            ...
                            "existing_characters": characters_info,
                            "plot_context": world_info,
                            "organization_specification": user_input or "自动生成",
                            "mcp_references": "",
...
async def auto_generate_organization(
    ...
    result = await engine.execute_skill(
        ...
        ai_client,
        {
            ...
            "existing_organizations": existing_orgs,
            "existing_characters": characters_info,
            "plot_context": json.dumps(req.analysis_result, ensure_ascii=False) if req.analysis_result else "",
            "organization_specification": req.specification or "根据分析结果自动生成",
            "mcp_references": "",
