...
export const outlineApi = {
  ...
  generate: (id: number, opts: { chapterCount?: number; narrativePov?: string } = {}) =>
    post(`/projects/${id}/outlines/generate-async`, { chapter_count: opts.chapterCount || 10, narrative_pov: opts.narrativePov || '' }),
