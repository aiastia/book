...
export function useProject() {
  ...
  /** 新建项目并设为当前项目 */
  async function createProject(title: string, genre: string = '', synopsis: string = '', options?: { target_word_count?: number; narrative_pov?: string; outline_mode?: string; target_platform?: string }) {
    ...
    if (options?.target_platform) body.target_platform = options.target_platform
