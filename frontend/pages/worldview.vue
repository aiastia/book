...
const { data: worlds, refresh: refreshWorlds } = await useFetch<any>(() => `/projects/${currentProjectId.value}/worldview`)
const { data: worldCore, refresh: refreshCore } = await useFetch<any>(() => `/projects/${currentProjectId.value}/worldview/core`)
