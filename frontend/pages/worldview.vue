...
const { data: worlds, refresh: refreshWorlds } = await useFetch<WorldSetting[]>(() => `/api/projects/${currentProjectId.value}/worldview`)
const { data: worldCore, refresh: refreshCore } = await useFetch<WorldCore>(() => `/api/projects/${currentProjectId.value}/worldview/core`)
