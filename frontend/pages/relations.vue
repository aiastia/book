...
const { data: characters, refresh: refresh } = await useFetch<any>(() => `/projects/${currentProjectId.value}/characters`)
...
// ===== 关系类型管理（子视图） =====
const { data: relationTypes, refresh: refreshTypes } = await useFetch<any>(() => `/projects/${currentProjectId.value}/relations/types`)
