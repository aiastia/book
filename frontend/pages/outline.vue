...
const { data: project, refresh: refresh } = await useFetch(() => `/projects/${currentProjectId.value}`)
const { data: outlines, refresh: refresh } = await useFetch(() => `/projects/${currentProjectId.value}/outlines`)
